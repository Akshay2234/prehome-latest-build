    ...
    >
          ...
          <Grid item xs={12} md={6}>
            ...
            <Box textAlign="left" my={4}>
              ...
              <Typography
                ...
                sx={{ color: { sx: "white", md: "black" } }}
              >
                Our EMI calculator instantly shows your monthly installments, total interest payable, and principal breakdown - helping you budget smarter for your future home.
              </Typography>
            </Box>
      ...
      >
        ...
        <DialogContent>
          ...
          We compute your Equated Monthly Installment (EMI) using the standard formula:
