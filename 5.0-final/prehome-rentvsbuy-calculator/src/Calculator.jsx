...
const Calculator = () => {
  ...
  const [saturationYear, setSaturationYear] = useState(2);
  ...
  const getIntersection = () => {
    ...
    for (let i = 1; i < rentData.length; i++) {
      ...
      if (
        ...
        const x = i - 1 + t; // The exact x-coordinate of the intersection
        const y = prevRent + slopeRent * t; // The exact y-coordinate of the intersection
    ...
    afterDatasetsDraw(chart) {
      ...
      if (saturationYear < rentArray.length) {
        ...
        const boxWidth = Math.min(
          ...
          chartArea.right - xCoord - 20 // Ensure it doesn't go off chart
        );
  ...
  const options = {
    ...
    scales: {
      ...
      y: {
        min: 0,
        max: house_cost <= 1.25 ? house_cost * 1.0e7 : 3.0e7,
        ticks: {
          stepSize: house_cost <= 1.25 ? 0.25e7 : 0.5e7,
  ...
  return (
    <Container maxWidth="lg" sx={{ padding: "16px", backgroundColor: "white" }}>
      <Grid container spacing={3}>
      <Grid item md={12} sx={{ display: { xs: "block", md: "block" }, textAlign: "left", px: { md: 3 },ml:3 }}>
  <Typography
    variant="h1"
    mb={1}
    sx={{ 
...
>
  <Grid item xs={6}>
    ...
    >
      ...
      />
      <Typography variant="h6">Renting</Typography>
    </Box>
  </Grid>
  <Grid item xs={6}>
    <Box 
    ...
    >
      ...
      />
      <Typography variant="h6">Buying</Typography>
    </Box>
  </Grid>
</Grid>
          {/* Text Below the Chart */}
          <Box sx={{ display: { xs: "none", md: "block",textAlign:'left' }, mt: 4, mr: 5,ml:5 }}>
        ...
        <Grid
          ...
          sx={{
            ...
            // paddingTop: { md: "24px" },
            marginTop: { md: "24px" },
            height: { md: "calc(100vh - 64px)" }, // Set height based on viewport
            ...
            "&::-webkit-scrollbar-track": {
              ...
              borderRadius: "8px", // Track border radius
              display: "none",
            },
            "&::-webkit-scrollbar-thumb": {
              backgroundColor: "#0086AD", // Scrollbar thumb color
              borderRadius: "8px", // Thumb border radius
              border: "2px solid #f0f0f0", // Optional border for thumb
              display: "none",
            },
            "&::-webkit-scrollbar-thumb:hover": {
              backgroundColor: "#005f73", // Color on hover for thumb
              display: "none",
            },
          }}
        >
          ...
          <Typography
            ...
            textAlign="left"
            fontWeight="bold"
            sx={{ mb: "16px", color: "#505050", textDecoration: "underline",cursor: "pointer" }}
...
>
  <DialogActions sx={{ 
    ...
    >
      ✕ {/* Using ✕ instead of X for better visual appearance */}
    </Button>
  </DialogActions>
